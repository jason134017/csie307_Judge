<?php
    ...
    if($Q=="0" ){
		...
		if( !empty($_POST['code']) ){
			...
			$sql = "SELECT * FROM `exam` WHERE `exam_id` LIKE '".$N."' ;";//查詢整個表單
		...
		$insert = "INSERT INTO `student_examgrade`(`compileID`, `account`, `examID`, `qid`, `response`,`grade`,`code`) VALUES ('".$id."','".$login."','".$N."','".$Q."','".$response."','".$grade."','".$code."')";
