...
<?php
    ...
    echo "<input name='competition'  type='hidden' value='".$competition."'>";
...
?>
選擇編譯器:
<select name="compiler" form="code" id="sel" style="font-size :20px">  
...
<?php
	echo "<input name='back' type='button' value='返回選項' style='font-size:18px' onclick=\"window.location.href='exam.php'\">";
?>
</form>
</body>
</html>